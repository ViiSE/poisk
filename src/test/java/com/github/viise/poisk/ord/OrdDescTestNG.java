...
public class OrdDescTestNG {
    ...
    public void apply() {
        ...
        Order<List<Integer>> ordDesc = new OrdDesc<>();
        List<Integer> result = ordDesc.sort(items);
    ...
    public void apply_itemsIsNull() {
        assertTrue(new OrdDesc<>().sort(null).isEmpty());
    }

    @Test
    public void apply_itemsIsEmpty() {
        List<Integer> items = new ArrayList<>();
        List<Integer> result = new OrdDesc<Integer>().sort(items);
