 ...
 * {@link Validator#validate(String, T)} as <code>null</code>. <code>checkedValueName<code/> used for exception message.
...
public interface Validator<T> {
     ...
     * @throws ValidationException If value is not validated.
     */
    void validate(String checkedValueName, T checkedValue) throws ValidationException;
    /**
     * checkedValueName is "value"
     * @param checkedValue Checked value.
     * @throws ValidationException If value is not validated.
     */
    void validate(T checkedValue) throws ValidationException;
}
