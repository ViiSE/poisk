...
public class OrdAscTestNG {
    ...
    public void apply() {
        ...
        Order<List<Integer>> ordAsc = new OrdAsc<>();
        List<Integer> result = ordAsc.sort(items);
    ...
    public void apply_itemsIsNull() {
        assertTrue(new OrdAsc<>().sort(null).isEmpty());
    }

    @Test
    public void apply_itemsIsEmpty() {
        List<Integer> items = new ArrayList<>();
        List<Integer> result = new OrdAsc<Integer>().sort(items);
