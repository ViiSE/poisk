...
public class OrdDescParallelTestNG {
    ...
    public void apply() {
        ...
        Order<List<Integer>> ordDescParallel = new OrdDescParallel<>();
        List<Integer> result = ordDescParallel.sort(items);
        ...
        assertEquals(result.get(0), Integer.valueOf(5));
        assertEquals(result.get(1), Integer.valueOf(4));
    ...
    public void apply_itemsIsNull() {
        assertTrue(new OrdDescParallel<>().sort(null).isEmpty());
    }

    @Test
    public void apply_itemsIsEmpty() {
        List<Integer> items = new ArrayList<>();
        List<Integer> result = new OrdDescParallel<Integer>().sort(items);
